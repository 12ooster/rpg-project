...
public abstract class UIActionMenuOptionScript : MonoBehaviour {
    ...
    /// <summary>
    /// Sets the item as currently selected in the menu and updates UI to show this.
    /// </summary>
    ...
    public void SetActive(bool active)
    {
        if (active)
        {
            if (this.ActiveIndicator != null)
            {
                this.ActiveIndicator.GetComponent<Image>().enabled = true;
            }
        }
        else
        {
            if (this.ActiveIndicator != null)
            {
                this.ActiveIndicator.GetComponent<Image>().enabled = false;
            }
        }
    }
